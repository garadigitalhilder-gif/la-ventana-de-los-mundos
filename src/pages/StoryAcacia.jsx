...
const book = books.find((item) => item.id === 'acacia');

export default function StoryAcacia() {
  if (!book) {
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#f6f8fb] px-4 py-6 text-slate-950 sm:px-6 sm:py-8 lg:px-8">
      <section className="mx-auto max-w-5xl">
        <div className="rounded-3xl bg-white p-5 shadow-xl shadow-slate-200 ring-1 ring-slate-200 sm:p-7 lg:p-10">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-600 sm:text-sm sm:tracking-[0.24em]">
            Lectura
          </p>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            <article className="rounded-3xl bg-emerald-50 p-5 ring-1 ring-emerald-100 sm:p-6">
